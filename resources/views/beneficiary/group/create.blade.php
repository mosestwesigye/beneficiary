...
@section('title')
    {{ trans_choice('general.add',1) }} {{ trans_choice('general.beneficiary',1) }} {{ trans_choice('general.group',1) }}
@endsection
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans_choice('general.add',1) }} {{ trans_choice('general.beneficiary',1) }} {{ trans_choice('general.group',1) }}</h3>

            <div class="box-tools pull-right">

            </div>
        </div>
        {!! Form::open(array('url' => url('beneficiary/group/store'), 'method' => 'post', 'class' => 'form-horizontal')) !!}
        <div class="box-body">
