...
@section('title')
    {{trans_choice('general.beneficiary',2)}} {{trans_choice('general.pending',1)}}
@endsection
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">{{trans_choice('general.beneficiary',2)}} {{trans_choice('general.pending',1)}}</h3>

            <div class="box-tools pull-right">
                @if(Sentinel::hasAccess('beneficiary.create'))
