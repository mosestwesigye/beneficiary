    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            @if(Sentinel::hasAccess('beneficiaries'))
                <li class="treeview @if(Request::is('beneficiary/*')) active @endif">
                    <a href="#">
                        <i class="fa fa-users"></i> <span>{{trans_choice('general.beneficiary',2)}}</span>
                        <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                    </a>
                    <ul class="treeview-menu">
                        @if(Sentinel::hasAccess('beneficiaries.view'))
                            <li><a href="{{ url('beneficiary/data') }}"><i
                                            class="fa fa-circle-o"></i> {{trans_choice('general.view',1)}} {{trans_choice('general.beneficiary',2)}}
                                </a></li>
                            <li>
                                <a href="{{ url('beneficiary/pending') }}"><i
                                            class="fa fa-circle-o"></i> {{trans_choice('general.beneficiary',2)}} {{trans_choice('general.pending',1)}}
                                    <span class="pull-right-container">
                                        <span class="label label-danger pull-right">{{\App\Models\Beneficiary::where('branch_id', session('branch_id'))->where('active',0)->count() }}</span>
                                    </span>
                                </a>
                            </li>
                        @endif
                        @if(Sentinel::hasAccess('beneficiaries.create'))
                            <li><a href="{{ url('beneficiary/create') }}"><i
                                            class="fa fa-circle-o"></i> {{trans_choice('general.add',1)}} {{trans_choice('general.beneficiary',2)}}
                                </a></li>
                        @endif
                        @if(Sentinel::hasAccess('beneficiary.groups'))
                            <li><a href="{{ url('beneficiary/group/data') }}"><i
                                            class="fa fa-circle-o"></i> {{trans_choice('general.view',1)}} {{trans_choice('general.beneficiary',1)}} {{trans_choice('general.group',2)}}
                                </a></li>
                        @endif
                        @if(Sentinel::hasAccess('beneficiary.groups'))
                            <li><a href="{{ url('beneficiary/group/create') }}"><i
                                            class="fa fa-circle-o"></i> {{trans_choice('general.add',1)}} {{trans_choice('general.beneficiary',1)}} {{trans_choice('general.group',1)}}
                                </a></li>
                        @endif
                    </ul>
                </li>
...
<!--
            @if(Sentinel::hasAccess('packages'))
                <li class="treeview @if(Request::is('package/*')) active @endif">
                    <a href="#">
                        <i class="fa fa-money"></i> <span>{{trans_choice('general.beneficiary_package',2)}}</span>
                        <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                    </a>
                    <ul class="treeview-menu">
                        @if(Sentinel::hasAccess('packages.view'))
                            <li><a href="{{ url('package/data') }}"><i
                                            class="fa fa-circle-o"></i> {{trans_choice('general.view',1)}} {{trans_choice('general.beneficiary_package',2)}}
                                </a></li>

                        @endif
                        @if(Sentinel::hasAccess('packages.create'))
                            <li><a href="{{ url('package/create') }}"><i
                                            class="fa fa-circle-o"></i> {{trans_choice('general.add',1)}} {{trans_choice('general.beneficiary_package',2)}}
                                </a></li>
                        @endif
                        @if(Sentinel::hasAccess('package.groups'))
                            <li><a href="{{ url('package/group/data') }}"><i
                                            class="fa fa-circle-o"></i> {{trans_choice('general.view',1)}} {{trans_choice('general.beneficiary_package',1)}} {{trans_choice('general.group',2)}}
                                </a></li>
                        @endif
                        @if(Sentinel::hasAccess('package.groups'))
                            <li><a href="{{ url('package/group/create') }}"><i
                                            class="fa fa-circle-o"></i> {{trans_choice('general.add',1)}} {{trans_choice('general.beneficiary_package',1)}} {{trans_choice('general.group',1)}}
                                </a></li>
                        @endif
                    </ul>
                </li>
