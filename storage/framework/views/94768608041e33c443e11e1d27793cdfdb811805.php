...
<?php $__env->startSection('content'); ?>
    ...
    <div class="box box-primary">
        ...
        <div class="box-body hidden-print">
            ...
            <div class="row">
                <div class="col-xs-5">
                    <?php echo Form::text('start_date',null, array('class' => 'form-control date-picker', 'placeholder'=>"Date",'required'=>'required')); ?>
    ...
    <div class="box box-info">
        <div class="row">
            <div class="col-sm-12 text-center">
                <h3><?php echo e(trans_choice('general.balance',1)); ?>  <?php echo e(trans_choice('general.sheet',1)); ?><br>
                    <?php if(!empty($start_date)): ?>
                        as at  <b><?php echo e($start_date); ?></b>
                    <?php else: ?>
                        as at <?php echo e(date("Y-m-d")); ?>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <table class="table table-bordered table-condensed table-hover">
                            ...
                            <tr style="background-color: #F2F8FF">
                                <td colspan="3" class="text-center"><b><?php echo e(trans_choice('general.asset',2)); ?></b></td>
                            </tr>
                            <tr>
                                <td class="text-bold text-blue">
                                    <b><?php echo e(trans_choice('general.current',1)); ?> <?php echo e(trans_choice('general.asset',2)); ?>:</b>
                                </td>
                                <td></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td><b>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(trans_choice('general.loan',2)); ?> <?php echo e(trans_choice('general.outstanding',2)); ?> </b>
                                </td>
                            ...
                            <tr>
                                <td><b>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(trans_choice('general.current',1)); ?></b>
                                </td>
                                <td style="text-align:right"><input type="text" name="current_loans_outstanding"
                                                                    id="inputCurrentLoansOutstanding" placeholder=""
                                                                    value="<?php echo e(round(\App\Helpers\GeneralHelper::loans_total_due($start_date,$end_date),2)); ?>"
                            ...
                            <tr>
                                <td><b>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(trans_choice('general.past_due',1)); ?></b>
                                </td>
                            ...
                            <tr>
                                <td><b>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(trans_choice('general.restructured',1)); ?></b>
                                </td>
                            ...
                            <tr>
                                <td><b>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(trans_choice('general.loan',2)); ?> <?php echo e(trans_choice('general.outstanding',1)); ?>

                                        (<?php echo e(trans_choice('general.gross',1)); ?>)</b></td>
                                <td style="text-align:right;"
                                    class="text-bold"><?php echo e(round(\App\Helpers\GeneralHelper::loans_total_due($start_date,$end_date),2)); ?></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td><b>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(<?php echo e(trans_choice('general.loan',1)); ?> <?php echo e(trans_choice('general.loss',1)); ?> <?php echo e(trans_choice('general.reserve',1)); ?>
                            ...
                            <tr>
                                <td><b>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(trans_choice('general.net',1)); ?> <?php echo e(trans_choice('general.loan',2)); ?>

                                        <?php echo e(trans_choice('general.outstanding',1)); ?></b></td>
                                <td></td>
                                <td style="text-align:right" class="text-bold">
                                    <div id="NetLoansOutstanding"><?php echo e(round(\App\Helpers\GeneralHelper::loans_total_due($start_date,$end_date),2)); ?></div>
                                </td>
                            </tr>
                            <tr class="active">
                                <td style="">
                                    <b><?php echo e(trans_choice('general.total',1)); ?> <?php echo e(trans_choice('general.current',1)); ?> <?php echo e(trans_choice('general.asset',2)); ?></b>
                                </td>
                                <td style=""></td>
                                <td style="text-align:right;" class="text-bold">
                                    <div id="TotalCurrentAssets"><?php echo e(round(\App\Helpers\GeneralHelper::loans_total_due($start_date,$end_date),2)); ?></div>
                                </td>
                            </tr>
                            <tr>
                                <td class="text-blue"><b><?php echo e(trans_choice('general.investment',2)); ?>:</b></td>
                                <td></td>
                                <td></td>
                            </tr>
                            <?php $investments = 0 ?>
                            <?php foreach(\App\Models\AssetType::where('type','investment')->get() as $key): ?>
                                <tr>
                                    <td class="text-bold"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($key->name); ?></b></td>
                                    <td style="text-align:right"><input type="text"
                                                                        name="investment_assets[<?php echo e($key->name); ?>]"
                                                                        id="inputFixedAssets1" placeholder=""
                                                                        value="<?php echo e(\App\Helpers\GeneralHelper::asset_type_valuation($key->id,$start_date)); ?>"
                                                                        class="balance_sheet_input decimal-2-places"
                                                                        onkeyup="update_balance_sheet()"></td>
                                    <td></td>
                                </tr>
                            ...
                            <tr class="active">
                                <td style=""><b>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(trans_choice('general.total',1)); ?> <?php echo e(trans_choice('general.investment',2)); ?></b>
                                </td>
                                <td style=""></td>
                                <td style="text-align:right;" class="text-bold">
                                    <div id="TotalInvestments"><?php echo e($investments); ?></div>
                                </td>
                            </tr>
                            <tr>
                                <td class="text-blue">
                                    <b><?php echo e(trans_choice('general.fixed',2)); ?> <?php echo e(trans_choice('general.asset',2)); ?>:</b></td>
                                <td></td>
                                <td></td>
                            </tr>
                            <?php $fixed = 0 ?>
                            <?php foreach(\App\Models\AssetType::where('type','fixed')->get() as $key): ?>
                                <tr>
                                    <td class="text-bold"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($key->name); ?></b></td>
                                    <td style="text-align:right"><input type="text" name="fixed_assets[<?php echo e($key->name); ?>]"
                                                                        id="inputFixedAssets1" placeholder=""
                                                                        value="<?php echo e(\App\Helpers\GeneralHelper::asset_type_valuation($key->id,$start_date)); ?>"
                                                                        class="balance_sheet_input decimal-2-places"
                                                                        onkeyup="update_balance_sheet()"></td>
                            ...
                            <tr class="active">
                                <td style=""><b>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(trans_choice('general.total',2)); ?> <?php echo e(trans_choice('general.fixed',2)); ?> <?php echo e(trans_choice('general.asset',2)); ?></b>
                                </td>
                                <td style=""></td>
                                <td style="text-align:right;" class="text-bold">
                                    <div id="TotalFixedAssets"><?php echo e($fixed); ?></div>
                                </td>
                            </tr>
                            <tr>
                                <td class="text-blue">
                                    <b><?php echo e(trans_choice('general.intangible',2)); ?> <?php echo e(trans_choice('general.asset',2)); ?>:</b>
                                </td>
                                <td></td>
                                <td></td>
                            </tr>
                            <?php $intangible = 0; ?>
                            <?php foreach(\App\Models\AssetType::where('type','intangible')->get() as $key): ?>
                                <tr>
                                    <td class="text-bold"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($key->name); ?></b></td>
                                    <td style="text-align:right"><input type="text"
                                                                        name="intangible_assets[<?php echo e($key->name); ?>]"
                                                                        id="inputFixedAssets1" placeholder=""
                                                                        value="<?php echo e(\App\Helpers\GeneralHelper::asset_type_valuation($key->id,$start_date)); ?>"
                                                                        class="balance_sheet_input decimal-2-places"
                                                                        onkeyup="update_balance_sheet()"></td>
                            ...
                            <tr class="active">
                                <td style=""><b>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(trans_choice('general.total',2)); ?> <?php echo e(trans_choice('general.intangible',2)); ?> <?php echo e(trans_choice('general.asset',2)); ?></b>
                                </td>
                                <td style=""></td>
                                <td style="text-align:right;" class="text-bold">
                                    <div id="TotalIntangibleAssets"><?php echo e($intangible); ?></div>
                                </td>
                            </tr>

                            <tr>
                                <td class="text-blue">
                                    <b><?php echo e(trans_choice('general.other',2)); ?> <?php echo e(trans_choice('general.asset',2)); ?>:</b></td>
                                <td></td>
                                <td></td>
                            </tr>
                            <?php $other = 0; ?>
                            <?php foreach(\App\Models\AssetType::where('type','other')->get() as $key): ?>
                                <tr>
                                    <td class="text-bold"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($key->name); ?></b></td>
                                    <td style="text-align:right"><input type="text" name="other_assets[<?php echo e($key->name); ?>]"
                                                                        id="inputFixedAssets1" placeholder=""
                                                                        value="<?php echo e(\App\Helpers\GeneralHelper::asset_type_valuation($key->id,$start_date)); ?>"
                                                                        class="balance_sheet_input decimal-2-places"
                                                                        onkeyup="update_balance_sheet()"></td>
                            ...
                            <tr class="active">
                                <td style=""><b>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(trans_choice('general.total',2)); ?> <?php echo e(trans_choice('general.other',2)); ?> <?php echo e(trans_choice('general.asset',2)); ?></b>
                                </td>
                                <td style=""></td>
                                <td style="text-align:right;" class="text-bold">
                                    <div id="TotalOtherAssets"><?php echo e($other); ?></div>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="col-sm-6">
                        <table class="table table-bordered table-condensed table-hover">
                            <tbody>
                            <tr style="background-color: #F2F8FF">
                                <td colspan="3" class="text-center"><b><?php echo e(trans_choice('general.liability',1)); ?> <?php echo e(trans_choice('general.and',2)); ?> <?php echo e(trans_choice('general.equity',1)); ?></b></td>
                            </tr>

                            <tr>
                                <td class="text-blue" colspan="2"><b><?php echo e(trans_choice('general.liability',2)); ?> </b></td>
                            </tr>
                            <?php
                            $savings=\App\Helpers\GeneralHelper::total_savings_deposits();
                            ?>
                            <tr>
                                <td><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(trans_choice('general.client',1)); ?>  <?php echo e(trans_choice('general.saving',2)); ?> </b></td>
                                <td style="text-align:right"><input type="text" name="client_savings"
                                                                    id="inputClientSavings" placeholder="" value="<?php echo e($savings); ?>"
                                                                    class="balance_sheet_input decimal-2-places"
                                                                    onkeyup="update_balance_sheet()"></td>
                            </tr>
                            <tr>
                                <td><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(trans_choice('general.account',2)); ?>  <?php echo e(trans_choice('general.payable',1)); ?> </b></td>
                            ...
                            <tr>
                                <td><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(trans_choice('general.wage',2)); ?>  <?php echo e(trans_choice('general.payable',1)); ?></b></td>
                            ...
                            <tr>
                                <td><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo e(trans_choice('general.short_term',1)); ?>  <?php echo e(trans_choice('general.borrowing',2)); ?></b></td>
                            ...
                            <tr>
                                <td><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(trans_choice('general.long_term',1)); ?>  <?php echo e(trans_choice('general.borrowing',2)); ?> (<?php echo e(trans_choice('general.commercial_rate',2)); ?>)</b></td>
                            ...
                            <tr class="info">
                                ...
                                <td style="text-align:right;" class="text-bold">
                                    <div id="TotalLiabilities"><?php echo e($savings); ?></div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right;" class="text-bold">
                                    <div id="LoanFundCapital"><?php echo e($other+$fixed+$intangible+$investments+round(\App\Helpers\GeneralHelper::loans_total_due($start_date,$end_date),2)-$savings); ?></div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr class="info">
                                ...
                                <td style="text-align:right;" class="text-bold">
                                    <div id="TotalEquity"><?php echo e($other+$fixed+$intangible+$investments+round(\App\Helpers\GeneralHelper::loans_total_due($start_date,$end_date),2)-$savings); ?></div>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="col-sm-6">
                        <table class="table table-bordered table-condensed table-hover">
                            ...
                            <tr class="info">
                                ...
                                <td style="text-align:right;" class="text-bold">
                                    <div id="TotalAssets"><?php echo e($other+$fixed+$intangible+$investments+round(\App\Helpers\GeneralHelper::loans_total_due($start_date,$end_date),2)); ?></div>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="col-sm-6">
                        <table class="table table-bordered table-condensed table-hover">
                            ...
                            <tr class="info">
                                ...
                                <td style="text-align:right;" class="text-bold">
                                    <div id="TotalLiabilitiesEquity"><?php echo e($other+$fixed+$intangible+$investments+round(\App\Helpers\GeneralHelper::loans_total_due($start_date,$end_date),2)); ?></div>
                                </td>
                            </tr>
                            </tbody>
                        </table>
