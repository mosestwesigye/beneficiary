<?php $__env->startSection('title'); ?>
    <?php echo e(trans_choice('general.beneficiary',2)); ?>
            ...
            <div class="table-responsive">
                <table id="data-table" class="table table-bordered table-condensed table-hover">
                    ...
                    <tr style="background-color: #D1F9FF">
                        ...
                        <th><?php echo e(trans_choice('general.national_id',1)); ?>#</th>
                        <th><?php echo e(trans_choice('general.ratio_id',1)); ?>#</th>
                        <th><?php echo e(trans_choice('general.country_of_origin',1)); ?>#</th>
                        <th><?php echo e(trans_choice('general.district_of_residence',1)); ?>#</th>
                    ...
                    <?php foreach($data as $key): ?>
                        <tr>
                            ...
                            <td><?php echo e($key->national_id); ?></td>
                            <td><?php echo e($key->ratio_id); ?></td>
                            <td><?php echo e($key->country); ?></td>
                            <td><?php echo e($key->district); ?></td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                        ...
                                        <?php if($key->active==1): ?>
                                            ...
                                            <?php endif; ?>
                                        <?php endif; ?>
                                        <?php if(Sentinel::hasAccess('beneficiaries.blacklist')): ?>
                                            <?php if($key->blacklisted==1): ?>
                                                <li><a href="<?php echo e(url('beneficiary/'.$key->id.'/unblacklist')); ?>"
                                                       class="delete"><i
                                            ...
                                            <?php if($key->blacklisted==0): ?>
                                                <li>
                                                    <a href="<?php echo e(url('beneficiary/'.$key->id.'/blacklist')); ?>"
                                                       class="delete"><i
