<?php $__env->startSection('title'); ?>
    <?php echo e(trans_choice('general.edit',1)); ?> <?php echo e(trans_choice('general.beneficiary_package',1)); ?> <?php echo e(trans_choice('general.product',1)); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title"><?php echo e(trans_choice('general.edit',1)); ?> <?php echo e(trans_choice('general.beneficiary_package',1)); ?> <?php echo e(trans_choice('general.product',1)); ?></h3>

            <div class="box-tools pull-right">

            </div>
        </div>
        <?php echo Form::open(array('url' => url('package/package_product/'.$package_product->id.'/update'), 'method' => 'post', 'class' => 'form-horizontal')); ?>
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <?php echo Form::text('name',$package_product->name, array('class' => 'form-control', 'placeholder'=>"",'required'=>'required')); ?>
                    ...
                    <div class="col-sm-3">
                        <?php foreach($package_disbursed_by as $key): ?>
                            <label> <input class="inputDisbursedById" type="checkbox" name="package_disbursed_by_id[]"
                                           ...
                                           <?php if(in_array($key->id,unserialize($package_product->package_disbursed_by_id))): ?> checked <?php endif; ?>><?php echo e($key->name); ?>
