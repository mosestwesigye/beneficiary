        ...
        <div class="box-body">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <?php echo Form::select('role', $role,'Client',array('class'=>'form-control')); ?>

                </div>
                <div class="form-group">
                    <?php echo Form::label(trans('general.address'),null,array('class'=>'control-label')); ?>

                    <?php echo Form::textarea('address','',array('class'=>'form-control wysihtml5')); ?>
                ...
                <div class="form-group">
                    ...
                    <?php echo Form::textarea('notes','',array('class'=>'form-control wysihtml5')); ?>
