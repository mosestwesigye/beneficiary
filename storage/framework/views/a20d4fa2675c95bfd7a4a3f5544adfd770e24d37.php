<?php $__env->startSection('title'); ?>
    <?php echo e(trans_choice('general.add',1)); ?> <?php echo e(trans_choice('general.payroll',1)); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="box box-primary">
        ...
        <?php echo Form::open(array('url' => url('payroll/store'), 'method' => 'post', 'name' => 'form',"enctype"=>"multipart/form-data")); ?>
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <?php echo Form::select('user_id',$user,null, array('class' => 'form-control select2','id'=>'user_id','placeholder'=>'Select')); ?>
                                ...
                                <tr>
                                    <td style="vertical-align: top;" width="50%">
                                        ...
                                        <table width="100%" id="payslip_employee_header">
                                            <tbody>
                                            <tr>
                                                <td width="50%" class="cell_format"><?php echo e(trans_choice('general.employee',1)); ?> <?php echo e(trans_choice('general.name',1)); ?></td>
                                                <td width="50%" class="cell_format">
                                                    <div class="margin text-bold">
                                                        <?php echo Form::text('employee_name',null, array('class' => 'form-control', 'id'=>"employee_name",'required'=>"required")); ?>
                                            ...
                                            <?php foreach($top_left as $key): ?>
                                                <tr>
                                                    ...
                                                    <td width="50%" class="cell_format">
                                                        <div class="margin text-bold">
                                                            <?php echo Form::text($key->id,null, array('class' => 'form-control', 'placeholder'=>"")); ?>
                                    ...
                                    <td style="vertical-align: top" width="50%">
                                        ...
                                        <table width="100%" id="pay_period_and_salary">
                                            ...
                                            <tr>
                                                <td width="50%" class="cell_format">
                                                    <div class="margin"><b><?php echo e(trans_choice('general.payroll',1)); ?> <?php echo e(trans_choice('general.date',1)); ?></b></div>
                                                </td>
                                                <td width="50%" class="cell_format">
                                                    <div class="margin text-bold">
                                                        <?php echo Form::text('date',date("Y-m-d"), array('class' => 'form-control date-picker', 'required'=>"required")); ?>

                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="50%" class="cell_format"><?php echo e(trans_choice('general.business',1)); ?> <?php echo e(trans_choice('general.name',1)); ?></td>
                                                <td width="50%" class="cell_format">
                                                    <div class="margin text-bold">
                                                        <?php echo Form::text('business_name',\App\Models\Setting::where('setting_key', 'company_name')->first()->setting_value, array('class' => 'form-control', 'id'=>"business_name",'required'=>"required")); ?>
                                ...
                                <tr>
                                    <td style="vertical-align: top" width="50%" class="borderRight">
                                        ...
                                        <table width="100%" id="hours_and_earnings">
                                            <tbody>
                                            <tr>
                                                <td width="50%" class="bg-navy"><b><?php echo e(trans_choice('general.description',1)); ?></b></td>
                                                <td width="50%" class="bg-navy"><b><?php echo e(trans_choice('general.amount',1)); ?></b></td>
                                            </tr>
                                            <?php
                                            $count = 0;
                                            ...
                                            <tr>
                                                ...
                                                <td width="50%" class="cell_format">
                                                    <div class="margin text-bold">
                                                        <?php echo Form::text($key->id,null, array('class' => 'form-control touchspin bottom_left', 'placeholder'=>"",'onkeyup'=>'refresh_totals()','id'=>'bottom_left'.$count)); ?>
                                    ...
                                    <td width="50%" valign="top">
                                        <table width="100%" id="pre_tax_deductions">
                                            ...
                                            <tr>
                                                ...
                                                <td width="50%" class="cell_format">
                                                    <div class="margin text-bold">
                                                        <?php echo Form::text($key->id,null, array('class' => 'form-control touchspin bottom_right', 'placeholder'=>"",'onkeyup'=>'refresh_totals()','id'=>'bottom_right'.$count)); ?>
                                ...
                                <tr>
                                    <td width="50%" class="bg-gray">
                                        <table width="100%" id="gross_pay">
                                            ...
                                            <tr>
                                                <td width="50%" class="cell_format">
                                                    <div class="margin"><b><?php echo e(trans_choice('general.total',1)); ?> <?php echo e(trans_choice('general.pay',1)); ?></b></div>
                                                </td>
                                                <td width="50%" class="cell_format">
                                                    <div class="margin text-bold">
                                                        <?php echo Form::text('total_pay',null, array('class' => 'form-control', 'readonly'=>"",'id'=>'total_pay')); ?>
                                    ...
                                    <td width="50%" class="bg-gray">
                                        ...
                                        <table width="100%" id="gross_pay">
                                            ...
                                            <tr>
                                                <td width="50%" class="cell_format">
                                                    <div class="margin"><b><?php echo e(trans_choice('general.total',1)); ?> <?php echo e(trans_choice('general.deduction',2)); ?></b></div>
                                                </td>
                                                <td width="50%" class="cell_format">
                                                    <div class="margin text-bold">
                                                        <?php echo Form::text('total_deductions',null, array('class' => 'form-control', 'readonly'=>"",'id'=>'total_deductions')); ?>
                                ...
                                <tr>
                                    ...
                                    <td width="50%" class="bg-gray">
                                        <table width="100%" id="gross_pay">
                                            ...
                                            <tr>
                                                <td width="50%" class="cell_format">
                                                    <div class="margin"><b><?php echo e(trans_choice('general.net',1)); ?> <?php echo e(trans_choice('general.pay',1)); ?></b></div>
                                                </td>
                                                <td width="50%" class="cell_format">
                                                    <div class="margin text-bold">
                                                        <?php echo Form::text('net_pay',null, array('class' => 'form-control', 'readonly'=>"",'id'=>'net_pay')); ?>
                        ...
                        <td style="padding-top:10px;">
                            <table width="100%" class="borderOk" id="net_pay_distribution">
                                ...
                                <tr>
                                    <td width="20%" class="cell_format">
                                        <div class="margin text-bold">
                                            <?php echo Form::text('payment_method',null, array('class' => 'form-control', 'required'=>"")); ?>
                                    ...
                                    <td width="20%" class="cell_format">
                                        <div class="margin text-bold">
                                            <?php echo Form::text('account_number',null, array('class' => 'form-control', ''=>"")); ?>
                                    ...
                                    <td width="20%" class="cell_format">
                                        <div class="margin text-bold">
                                            <?php echo Form::text('paid_amount',null, array('class' => 'form-control', 'id'=>"paid_amount")); ?>
                        ...
                        <td>
                            <table width="100%" class="borderOk" style="margin-top:10px" id="messages">
                                ...
                                <tr>
                                    <td width="100%" class="cell_format">
                                        <div class="margin text-bold">
                                            <?php echo Form::textarea('comments',null, array('class' => 'form-control', ''=>"")); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="form-line">
                                    ...
                                    <?php echo Form::select('recur_type', array('day'=>'Day(s)','week'=>'Week(s)','month'=>'Month(s)','year'=>'Year(s)'),'month', array('class' => 'form-control','id'=>'recurT')); ?>
