<?php $__env->startSection('title'); ?><?php echo e(trans_choice('general.other_income',1)); ?> <?php echo e(trans_choice('general.type',2)); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title"><?php echo e(trans_choice('general.other_income',1)); ?> <?php echo e(trans_choice('general.type',2)); ?></h3>

            <div class="box-tools pull-right">
                <a href="<?php echo e(url('other_income/type/create')); ?>"
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="<?php echo e(url('other_income/type/'.$key->id.'/edit')); ?>"><i
                                                    class="fa fa-edit"></i> <?php echo e(trans('general.edit')); ?> </a></li>
                                    <li><a href="<?php echo e(url('other_income/type/'.$key->id.'/delete')); ?>"
                                           class="delete"><i
