<?php $__env->startSection('title'); ?><?php echo e(trans_choice('general.beneficiary_package',1)); ?> <?php echo e(trans_choice('general.product',2)); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title"><?php echo e(trans_choice('general.beneficiary_package',1)); ?> <?php echo e(trans_choice('general.product',2)); ?></h3>

            <div class="box-tools pull-right">
                <a href="<?php echo e(url('package/package_product/create')); ?>"
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <?php if(Sentinel::hasAccess('packages.update')): ?>
                                        <li><a href="<?php echo e(url('package/package_product/'.$key->id.'/edit')); ?>"><i
                                                        class="fa fa-edit"></i> <?php echo e(trans('general.edit')); ?> </a></li>
                                    <?php endif; ?>
                                    <?php if(Sentinel::hasAccess('packages.delete')): ?>
                                        <li><a href="<?php echo e(url('package/package_product/'.$key->id.'/delete')); ?>"
                                               class="delete"><i
