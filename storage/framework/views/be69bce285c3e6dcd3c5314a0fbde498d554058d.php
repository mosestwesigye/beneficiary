<?php $__env->startSection('title'); ?>
    <?php echo e(trans_choice('general.edit',1)); ?> <?php echo e(trans_choice('general.custom_field',1)); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title"><?php echo e(trans_choice('general.edit',1)); ?> <?php echo e(trans_choice('general.custom_field',1)); ?></h3>

            <div class="box-tools pull-right">

            </div>
        </div>
        <?php echo Form::open(array('url' => url('custom_field/'.$custom_field->id.'/update'), 'method' => 'post', 'name' => 'form')); ?>
        ...
        <div class="box-body">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <?php echo Form::text('name',$custom_field->name, array('class' => 'form-control', 'placeholder'=>trans_choice('general.field',1).' '.trans_choice('general.name',1),'required'=>'required')); ?>

                </div>
                <div class="form-group">
                    <label><?php echo e(trans_choice('general.required_field',1)); ?> </label>
                    <label><input type="radio" name="required" required value="0"
                                  <?php if($custom_field->required==0): ?> checked <?php endif; ?>> <?php echo e(trans_choice('general.no',1)); ?></label>
                    <label><input type="radio" name="required" required value="1" <?php if($custom_field->required==1): ?> checked <?php endif; ?>> <?php echo e(trans_choice('general.yes',1)); ?></label>
                </div>
                <div class="form-group">
                    ...
                    <table class="table table-bordered">
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="field_type" id="inputType" value="textfield"
                                               required="" <?php if($custom_field->field_type=="textfield"): ?> checked <?php endif; ?>> <b><?php echo e(trans_choice('general.text_field',1)); ?></b>
                        ...
                        <tr>
                            <td>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="field_type" id="inputType" value="date" required="" <?php if($custom_field->field_type=="date"): ?> checked <?php endif; ?>>
                        ...
                        <tr>
                            <td>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="field_type" id="inputType" value="number" required="" <?php if($custom_field->field_type=="number"): ?> checked <?php endif; ?>>
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="field_type" id="inputType" value="decimal"
                                               required="" <?php if($custom_field->field_type=="decimal"): ?> checked <?php endif; ?>> <b><?php echo e(trans_choice('general.decimal_field',1)); ?></b>
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="field_type" id="inputType" value="textarea"
                                               required="" <?php if($custom_field->field_type=="textarea"): ?> checked <?php endif; ?>> <b><?php echo e(trans_choice('general.textarea',1)); ?></b>
