...
<?php $__env->startSection('content'); ?>
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title"><?php echo e(trans_choice('general.bank',1)); ?> <?php echo e(trans_choice('general.account',2)); ?></h3>

            <div class="box-tools pull-right">
                <?php if(Sentinel::hasAccess('capital.create')): ?>
                    <a href="<?php echo e(url('capital/bank/create')); ?>"
                       class="btn btn-info btn-sm"><?php echo e(trans_choice('general.add',1)); ?> <?php echo e(trans_choice('general.bank',1)); ?> <?php echo e(trans_choice('general.account',1)); ?></a>
                <?php endif; ?>
            </div>
        </div>
        <div class="box-body ">
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <?php if(Sentinel::hasAccess('capital.update')): ?>
                                            <li><a href="<?php echo e(url('capital/bank/'.$key->id.'/edit')); ?>"><i
                                                            class="fa fa-edit"></i> <?php echo e(trans('general.edit')); ?> </a>
                                            </li>
                                        <?php endif; ?>
                                        <?php if(Sentinel::hasAccess('capital.delete')): ?>
                                            <li><a href="<?php echo e(url('capital/bank/'.$key->id.'/delete')); ?>" class="delete"><i
